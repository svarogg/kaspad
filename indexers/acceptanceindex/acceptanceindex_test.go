...
//		BlockHash: *hash,
//		TxAcceptanceData: []common.TxAcceptanceData{
//			{
...
//		},
//	}
//	multiBlockTxsAcceptanceData := common.MultiBlockTxsAcceptanceData{blockTxsAcceptanceData}
//
//	// Serialize
...
//		blockTmp, err := test.LoadBlocks(filepath.Join("../../consensus/test/", file))
//		if err != nil {
