...
func NewGetBlocksRequestMessage(lowHash string, includeBlockVerboseData bool) *GetBlocksRequestMessage {
...
func NewGetBlocksResponseMessage(blockHashes []string,
