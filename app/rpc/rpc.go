...
var handlers = map[appmessage.MessageCommand]handler{
	...
	appmessage.CmdNotifyTransactionAddedRequestMessage:     rpchandlers.HandleNotifyTransactionAdded,
	appmessage.CmdNotifyUTXOOfAddressChangedRequestMessage: rpchandlers.HandleNotifyUTXOOfAddressChanged,
