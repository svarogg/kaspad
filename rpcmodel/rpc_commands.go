...
// NewConnectCmd returns a new instance which can be used to issue an addManualNode
// JSON-RPC command.
func NewConnectCmd(addr string, oneTry *bool) *ConnectCmd {
	return &ConnectCmd{
		Target: addr,
		OneTry: oneTry,
	}
...
// NewDisconnectCmd returns a new instance which can be used to issue a disconnect
// JSON-RPC command.
func NewDisconnectCmd(target string) *DisconnectCmd {
...
func NewGetPeerInfoCmd(node string, details *bool) *GetPeerInfoCmd {
...
func init() {
	...
	MustRegisterCommand("addManualNode", (*ConnectCmd)(nil), flags)
	...
	MustRegisterCommand("getManualNodeInfo", (*GetPeerInfoCmd)(nil), flags)
	...
	MustRegisterCommand("removeManualNode", (*DisconnectCmd)(nil), flags)
