...
//			dagParams.K = test.k
//			dag, teardownFunc, err := blockdag.DAGSetup(fmt.Sprintf("TestGHOSTDAG%d", i), true, blockdag.Config{
//				DAGParams: &dagParams,
//			})
//			if err != nil {
...
//	dag, teardownFunc, err := blockdag.DAGSetup("TestBlueAnticoneSizeErrors", true, blockdag.Config{
//		DAGParams: &dagconfig.SimnetParams,
//	})
//	if err != nil {
...
//		newBlock := blockdag.prepareAndProcessBlockByParentMsgBlocks(t, dag, currentBlockA)
...
//	for i := dagconfig.KType(0); i < dag.Params.K; i++ {
//		newBlock := blockdag.prepareAndProcessBlockByParentMsgBlocks(t, dag, currentBlockB)
...
//	// Create a new database and DAG instance to run tests against.
//	dag, teardownFunc, err := blockdag.DAGSetup("TestGHOSTDAGErrors", true, blockdag.Config{
//		DAGParams: &dagconfig.SimnetParams,
//	})
//	if err != nil {
...
//	block1 := blockdag.prepareAndProcessBlockByParentMsgBlocks(t, dag, dag.Params.GenesisBlock)
//	block2 := blockdag.prepareAndProcessBlockByParentMsgBlocks(t, dag, dag.Params.GenesisBlock)
//
//	// Add a child block to the previous two blocks
//	block3 := blockdag.prepareAndProcessBlockByParentMsgBlocks(t, dag, block1, block2)
//
